...
> ⚠️ **已过时 (2026-07-08 更新)**: 本文档记录 2026-06-24 的阻塞项分析。此后
> **B1/B2/B3 已修复,B6 零差异捕获已验证**,DAG 执行与确定性零差异捕获均已在真实
> Folia 服务器上验证通过。唯一剩余的核心阻塞项是 **B4(性能/MSPT,尚未测量)**。
> 当前状态请见 [PROJECT_STATUS.md](PROJECT_STATUS.md)。本文档保留作历史记录。

**最后更新**: 2026-06-24 (历史快照)
**当前分支**: feat/fix-folia-scheduler-v2
**测试机**: 本地 kuli-OptiPlex-7060 (/home/kuli/nebula)
